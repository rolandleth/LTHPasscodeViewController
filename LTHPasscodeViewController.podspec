...
Pod::Spec.new do |s|
  ...
  s.version      = "3.1.3-glow"
  s.summary      = "A short description of LTHPasscodeViewController."

  s.description  = <<-DESC
                   A longer description of LTHPasscodeViewController in Markdown format.
  ...
  s.author             = { "Bob" => "bob@upwlabs.com" }
  # Or just: s.author    = "Bob"
  # s.authors            = { "Bob" => "bob@upwlabs.com" }
  ...
  s.source       = { :git => "https://github.com/upwlabs/LTHPasscodeViewController", :tag => "3.1.3-glow" }
